...
A nivel mundial, la problemática del desarrollo infantil presenta dimensiones 
alarmantes. UNICEF reporta que aproximadamente 250 millones de niños menores 
de 5 años están en riesgo de no alcanzar su potencial de desarrollo, mientras 
que cerca de 200 millones presentan retrasos en su desarrollo global debido a 
la desnutrición en la primera infancia \cite{UNICEF2023}. Esta realidad se 
intensifica particularmente en países de ingresos bajos y medios, donde las 
adversidades socioeconómicas, la pobreza y el acceso limitado a servicios de 
salud crean un entorno adverso para el desarrollo infantil óptimo.

En Guatemala, esta problemática adquiere características particulares debido 
a la convergencia de múltiples factores de riesgo socioeconómicos y 
ambientales. El país presenta uno de los panoramas más desafiantes de América 
Latina en materia de desarrollo infantil: según el informe de la línea de base 
...
ambientales que caracterizan esta zona. La región presenta una compleja 
diversidad étnica y cultural, con una predominancia de población indígena que 
habita principalmente en áreas rurales, donde el acceso a servicios de salud 
y programas de estimulación temprana es particularmente limitado. A pesar de 
constituir una de las regiones económicamente más activas del país, persisten 
importantes desafíos en términos de equidad en el acceso a oportunidades de 
desarrollo infantil.

La evidencia científica internacional ha demostrado consistentemente 
asociaciones significativas entre diversos factores de riesgo y el retraso en 
el desarrollo infantil. Investigaciones realizadas en países de ingresos 
medianos y bajos han identificado que factores como el bajo peso al nacer, el 
nivel educativo materno, las condiciones socioeconómicas adversas y el acceso 
limitado a servicios de salud están fuertemente asociados con retrasos en 
múltiples dominios del desarrollo \cite{Wondmagegn2024}. Sin embargo, existe 
una brecha crítica en la investigación sobre estos factores en el contexto 
específico de Quetzaltenango, donde la interacción de variables culturales, 
socioeconómicas y geográficas particulares requiere un análisis localizado y 
específico.

Esta investigación surge de la necesidad imperante de generar evidencia 
científica local que permita comprender las dinámicas específicas de los 
factores de riesgo asociados al neurodesarrollo infantil en los servicios de 
atención primaria de Quetzaltenango. El estudio busca llenar este vacío 
crítico en la literatura, proporcionando datos empíricos que sirvan como base 
sólida para el diseño de intervenciones específicas, estrategias de prevención 
y políticas públicas orientadas a mejorar los resultados de desarrollo en la 
primera infancia.

El objetivo principal de esta investigación es establecer la asociación entre 
factores sociodemográficos, económicos, familiares y médicos con el riesgo en 
el neurodesarrollo en niños menores de 5 años que asisten a servicios de 
atención primaria en el distrito de Quetzaltenango, mediante evaluaciones 
sistemáticas con el \asq. Específicamente, se busca clasificar los resultados 
según grupos de edad para detectar patrones específicos de riesgo, evaluar la 
asociación entre diversos factores de riesgo y el neurodesarrollo, y analizar 
la relación entre el acceso a servicios de salud y la presencia de riesgo de 
retraso en el desarrollo.

Los resultados de este estudio proporcionarán evidencia fundamental para 
comprender los determinantes locales del neurodesarrollo infantil en 
Quetzaltenango, contribuyendo así al diseño de intervenciones más efectivas y 
políticas públicas basadas en evidencia que puedan mejorar significativamente 
las oportunidades de desarrollo para los niños de esta región, especialmente 
aquellos en situación de mayor vulnerabilidad socioeconómica y cultural.
