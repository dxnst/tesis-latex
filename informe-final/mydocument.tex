...
\item \textit{Estadísticas descriptivas:} Edad materna promedio: 28.2 años (DE: 5.4); Edad paterna promedio: 30.1 años (DE: 6.1).
\item \textit{Fuente:} Boleta de recolección de datos.
\end{tablenotes}
\end{threeparttable}
\end{table}
...
\begin{tablenotes}
\footnotesize
\item \textit{Nota:} Promedio de personas por hogar: 5.2 (DE: 2.1); Promedio de hermanos: 1.2 (DE: 1.1).
\item \textit{Fuente:} Boleta de recolección de datos.
\end{tablenotes}
\end{threeparttable}
\end{table}
...
\begin{tablenotes}
\footnotesize
\item \textit{Nota:} Promedio de controles prenatales: 6.2 (DE: 2.1).
\item \textit{Fuente:} Boleta de recolección de datos.
\end{tablenotes}
\end{threeparttable}
\end{table}
